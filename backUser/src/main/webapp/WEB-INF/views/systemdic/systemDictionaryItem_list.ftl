	...
	<script type="text/javascript">
		$(function(){
			...
			$(".delete_Btn").click(function(){
				var json = $(this).data("jsonstring");
				$.get("/systemDictionaryItem_delete.do",{id:json.id},function(data){
					if(data.success){
								...
								<#list pageResult.listData as vo>
									<tr>
										...
										<td>
											...
											<a href="javascript:void(-1);" class="delete_Btn" data-jsonstring='${vo.jsonString}' >删除</a>
										</td>
									</tr>
								</#list>
								</tbody>
