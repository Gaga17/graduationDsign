...
<title>P2P平台-实名认证</title> <#include "common/links-tpl.ftl" />
<link type="text/css" rel="stylesheet" href="/css/account.css" />
<link type="text/css" rel="stylesheet"
	href="/js/plugins/uploadify/uploadify.css" />
						...
						<fieldset>
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									...
									<input id="bornDate" class="form-control" name="birthDate"
										type="text">
								...
								<div class="col-sm-8">
									...
									<div class="idCardItem">
										<div>
											...
											<!-- <input type="file" id="uploadBtn1" ></input> -->
										</div>
