...
public class SendEmailService {
	private static final String EMAIL_OWNER_ADDR_HOST = "smtp.aliyun.com"; // smtp.163.com
																			// smtp.aliyun.com
																			// smtp.qq.com
	private static final String EMAIL_OWNER_ADDR = "GDUT_CJJ@aliyun.com";
	private static final String EMAIL_OWNER_ADDR_PASS = "cjj12345";
	...
	public static void main(String[] args) throws Exception {
		// sendMail("吸引力注册邮件", "xxx@qq.com", "您的注册验证码为:<b
		// style=\"color:blue;\">651899</b>");
		sendMail("吸引力", "1394446290@qq.com", "毕业设计邮件测试");
	}
}
